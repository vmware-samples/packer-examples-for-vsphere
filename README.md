...
- Packer plugins:
  ...
  - HashiCorp [Packer Plugin for VMware vSphere][packer-plugin-vsphere] 1.2.1 or later.
  - [Packer Plugin for Git][packer-plugin-git] 0.4.3 or later - a community plugin for HashiCorp Packer.
