...
1. Download the x64 guest operating system [.iso][iso] images.
    ...
    * VMware Photon OS 4 Server
        * [Download][download-linux-photon-server-4] the latest release of the **FULL** `.iso` image. (_e.g._ ``)
    * Ubuntu Server 20.04 LTS
        * [Download][download-linux-ubuntu-server-20-04-lts] the latest **LIVE** release `.iso` image. (_e.g._ 1ubuntu-20.04.2-live-server-amd64.iso1)
    * Ubuntu Server 18.04 LTS
        * [Download][download-linux-ubuntu-server-18-04-lts] the latest legacy **NON-LIVE** release `.iso` image. (_e.g._ ``)
    * Red Hat Enterprise Linux 8 Server
