...
variable "vm_guest_os_vendor" {
  type        = string
  description = "The guest operating system vendor. Used for naming . (e.g. 'centos-linux')"
}
...
variable "iso_file" {
  type        = string
  description = "The file name of the ISO image used by the vendor. (e.g. 'CentOS-<version>-x86_64-DVD-2009.iso')"
}
