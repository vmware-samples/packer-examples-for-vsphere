...
variable "vm_guest_os_vendor" {
  type        = string
  description = "The guest operating system vendor. Used for naming . (e.g. 'redhat-linux')"
}
...
variable "iso_file" {
  type        = string
  description = "The file name of the ISO image used by the vendor. (e.g. 'rhel-server-<verssion>-x86_64-dvd.iso')"
}
