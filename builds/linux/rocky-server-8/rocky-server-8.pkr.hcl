...
# Packer template for Rocky Linux 8 Server.
...
variable "iso_file" {
  type    = string
  description = "The file name of the ISO image. (e.g. 'iso-rocky-server-8.iso')"
  default = ""
}

variable "iso_checksum" {
  type    = string
  description = "The SHA-512 checkcum of the ISO image. (e.g. Result of 'shasum -a 512 iso-linux-rocky-server-8.iso')"
  default = ""
}
...
variable "http_directory" {
  type    = string
  description = "The HTTP endpoint directory path. (e.g. ../../../configs/linux/rocky-server/)"
  default = ""
}
...
variable "vm_guest_os_vendor" {
  type    = string
  description = "The guest operatiing system vendor. Used for naming. (e.g. 'rocky)"
  default = ""
}
...
variable "vm_firmware" {
  type    = string
  description = "The virtual machine firmware. (e.g. 'bios')"
  default = "bios"
}
...
source "vsphere-iso" "linux-rocky-server" {
...
build {
  sources = ["source.vsphere-iso.linux-rocky-server"]
  /*
