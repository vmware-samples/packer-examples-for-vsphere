...
read -r -p "Skip export to content library (recommended: ""${common_content_library_skip_import}""): " common_content_library_skip_import
...
export PKR_VAR_common_content_library_skip_import="${common_content_library_skip_import}"
...
case $display_environmental_variables in
    ...
    echo - PKR_VAR_common_content_library_skip_import: "$PKR_VAR_common_content_library_skip_import"
